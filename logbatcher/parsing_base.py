...
def single_dataset_paring(dataset, contents, output_dir, parser, batch_size = 10, chunk_size = 10000, clustering_method = 'dbscan', debug=True):
    ...
    llm_usage = parser.get_llm_usage_metrics() if hasattr(parser, "get_llm_usage_metrics") else {
        ...
        "r2r_endpoint_invocations": 0,
        "r2r_endpoint_latency_sec": 0,
        "r2r_endpoint_avg_latency_sec": 0,
        "r2r_reference_invocations": 0,
        "r2r_reference_latency_sec": 0,
        "r2r_reference_avg_latency_sec": 0,
    }
    r2r_trace_metrics = (
    ...
    r2r_metrics[dataset] = {
        ...
        "r2r_endpoint_invocations": llm_usage.get("r2r_endpoint_invocations", 0),
        "r2r_endpoint_latency_sec": llm_usage.get("r2r_endpoint_latency_sec", 0),
        "r2r_endpoint_avg_latency_sec": llm_usage.get("r2r_endpoint_avg_latency_sec", 0),
        "r2r_reference_invocations": llm_usage.get("r2r_reference_invocations", 0),
        "r2r_reference_latency_sec": llm_usage.get("r2r_reference_latency_sec", 0),
        "r2r_reference_avg_latency_sec": llm_usage.get("r2r_reference_avg_latency_sec", 0),
    ...
    csv_fields = [
        ...
        "llm_latency_sec",
        "llm_avg_latency_sec",
        "r2r_endpoint_invocations",
        "r2r_endpoint_latency_sec",
        "r2r_endpoint_avg_latency_sec",
        "r2r_reference_invocations",
        "r2r_reference_latency_sec",
    ...
    with open(r2r_metrics_csv, 'w', newline='') as file:
        ...
        for dataset_name, metrics in sorted(r2r_metrics.items()):
            writer.writerow({
                ...
                "r2r_endpoint_invocations": metrics.get("r2r_endpoint_invocations", 0),
                "r2r_endpoint_latency_sec": metrics.get("r2r_endpoint_latency_sec", 0),
                "r2r_endpoint_avg_latency_sec": metrics.get("r2r_endpoint_avg_latency_sec", 0),
                "r2r_reference_invocations": metrics.get("r2r_reference_invocations", 0),
                "r2r_reference_latency_sec": metrics.get("r2r_reference_latency_sec", 0),
                "r2r_reference_avg_latency_sec": metrics.get("r2r_reference_avg_latency_sec", 0),
